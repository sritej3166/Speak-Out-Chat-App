...
import com.example.home.chatapp.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    /**
     Initialising the components needed for login management
     */
    private void initFirebase() {
        ...
        //Initialized when the login dialog waiting
    ...
    /**
     * Utility described for login,registration...
     */
    class AuthUtils {
        /**
         * Action register
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setTitle("Could'nt register")
                                        .setMessage("Email exists already or weak password!")
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setMessage("Email doesn't exist or Wrong password!")
                                        .setCancelable(false)
                                        .setConfirmButtonText("Ok")
                                        .show();
                            } else {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            new LovelyInfoDialog(LoginActivity.this) {
                                ...
                                public LovelyInfoDialog setConfirmButtonText(String text) {
                                    ...
                                    .setMessage("Send email to " + email)
                                    .setConfirmButtonText("Ok")
                                    .show();
                        }
                    })
                ...
                public void onFailure(@NonNull Exception e) {
                    new LovelyInfoDialog(LoginActivity.this) {
                        ...
                        public LovelyInfoDialog setConfirmButtonText(String text) {
                            ...
                            .setIcon(R.drawable.ic_pass_reset)
                            .setTitle("Error")
                            .setMessage("Failed to send mail to " + email)
                            .setConfirmButtonText("Ok")
                            .show();
                }
            });
        ...
        /**
         * to save information for the user login info
         */
        void saveUserInfo() {
