...
import com.example.home.chatapp.ui.FriendsFragment;
import com.example.home.chatapp.ui.GroupFragment;
import com.example.home.chatapp.ui.LoginActivity;
import com.example.home.chatapp.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            Objects.requireNonNull(getSupportActionBar()).setTitle("Speakout");
        }
    ...
    private void initFirebase() {
        //Initialise components to login,register
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                } else floatButton.setVisibility(View.GONE);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Chat app by Sri Teja Vure", Toast.LENGTH_LONG).show();
            return true;
        }
